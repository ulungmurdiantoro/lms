                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#midtrans-setting" class="nav-link" data-bs-toggle="tab"
                                        aria-selected="true" role="tab">Midtrans Settings</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane show" id="midtrans-setting" role="tabpanel">
                                    <form action="{{ route('admin.midtrans-setting.update') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    <label class="form-label">Midtrans Status</label>
                                                    <select name="midtrans_status" class="form-control" >
                                                        <option @selected(config('gateway_settings.midtrans_status') === 'active') value="active">Active</option>
                                                        <option @selected(config('gateway_settings.midtrans_status') === 'inactive') value="inactive">Inactive</option>
                                                    </select>
                                                    <x-input-error :messages="$errors->get('midtrans_status')" class="mt-2" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="mb-3">
                                                    <label class="form-label">Currency</label>
                                                    <select name="midtrans_currency" class="form-control select2" >
                                                        @foreach(config('gateway_currencies.midtrans_currencies') as $key => $value)
                                                        <option @selected(config('gateway_settings.midtrans_currency') == $value)  value="{{ $value }}">{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                    
                                                    <x-input-error :messages="$errors->get('midtrans_currency')" class="mt-2" />
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="mb-3">
                                                    <label class="form-label">Rate (USD)</label>
                                                    <input type="text" class="form-control" name="midtrans_rate"
                                                        placeholder="Enter midtrans Rate" value="{{ config('gateway_settings.midtrans_rate') }}">
                                                    <x-input-error :messages="$errors->get('midtrans_rate')" class="mt-2" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="midtrans_id"
                                                        placeholder="Enter midtrans key" value="{{ config('gateway_settings.midtrans_id') }}">
                                                    <x-input-error :messages="$errors->get('midtrans_id')" class="mt-2" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="midtrans_client"
                                                        placeholder="Enter midtrans client secret" value="{{ config('gateway_settings.midtrans_client') }}">
                                                    <x-input-error :messages="$errors->get('midtrans_client')" class="mt-2" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="midtrans_server"
                                                        placeholder="Enter midtrans client secret" value="{{ config('gateway_settings.midtrans_server') }}">
                                                    <x-input-error :messages="$errors->get('midtrans_server')" class="mt-2" />
                                                </div>
                                            </div>
